    ...
    <Box style={{ height: 180, padding: 10, width: '100%', flexDirection: 'column', justifyContent: 'space-between' }}>
      <Box style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
        <Box style={{ backgroundColor: color.primary, padding: 5, width: '30%', borderRadius: 15 }}>
          <Text style={{ color: "white", textAlign: 'center', fontWeight: typography.h1.fontWeight }}>#{item.id}</Text>
        </Box >
        <Box style={{ padding: 5 }}>
          <Text style={{ color: "black", textAlign: 'center', fontWeight: typography.h1.fontWeight }}>{item.status}</Text>
        </Box >
      </Box>
      <Box style={{ gap: 10, marginTop: 10 }}>
        <Text style={{ color: "black", fontWeight: typography.bold.fontWeight,fontSize:typography.subtitle.fontSize }}>Address : {item.address}</Text>
        <Text style={{ color: "black", fontWeight: typography.bold.fontWeight }}>Time: {item.timestamp}</Text>
      </Box>
      ...
      <Box style={{ flexDirection: 'row', width: '100%', justifyContent: 'space-between' }}>
        ...
        {/* <TouchableOpacity style={{ width: '45%' }} onPress={() => handleRejectOrder(item.id)}>
          <Box style={{ backgroundColor: 'orange', justifyContent: 'center', alignItems: 'center', flexDirection: 'row', padding: 10, borderRadius: 20 }}>
            <Text style={{ color: "white", textAlign: 'center', fontSize: 18, fontWeight: 'typography.bold.fontWeight' }}> Reject </Text>
          </Box>
        </TouchableOpacity> */}
      </Box>
