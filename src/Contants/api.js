...
export const apiBaseUrl = 'https://4tz1dlbqqblp.share.zrok.io';
...
export const signup = "/api/auth/deliveryPerson/signup";
export const signin = "/api/auth/v1/signin";

// Profile Endpoints
export const getProfileById = "/api/v1/delivery/profile/3";
